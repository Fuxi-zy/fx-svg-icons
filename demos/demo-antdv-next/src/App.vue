...
<template>
  <div class="layout">
    <aside class="sidebar">
      ...
      <ul class="dep-list">
        <li v-for="(version, name) in dependencies" :key="name">
          <a-tooltip :title="`${name}: ${version}`" placement="right">
    ...
    <div class="demo">
    <h1>@fuxishi/svg-icon Demo (Ant Design Vue Next)</h1>

    <section>
      <h2>Element Plus 图标 (ep:xxx)</h2>
      <div class="icon-list">
        <div class="icon-item">
          <FxIcon name="ep:home-filled" size="32px" color="#1677ff" />
          <span>ep:home-filled</span>
        </div>
        <div class="icon-item">
          <FxIcon name="ep:user" size="32px" color="#1677ff" />
          <span>ep:user</span>
        </div>
        <div class="icon-item">
          <FxIcon name="ep:setting" size="32px" color="#faad14" />
          <span>ep:setting</span>
        </div>
        <div class="icon-item">
          <FxIcon name="ep:search" size="32px" color="#ff4d4f" />
          <span>ep:search</span>
        </div>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="icon-list">
        <div class="icon-item">
          <FxIcon name="ant-design:home-outlined" size="32px" color="#1677ff" />
          <span>ant-design:home-outlined</span>
        </div>
        <div class="icon-item">
          <FxIcon name="ant-design:user-outlined" size="32px" color="#1677ff" />
          <span>ant-design:user-outlined</span>
        </div>
        <div class="icon-item">
          <FxIcon name="ant-design:setting-outlined" size="32px" color="#faad14" />
          <span>ant-design:setting-outlined</span>
        </div>
        <div class="icon-item">
          <FxIcon name="ant-design:search-outlined" size="32px" color="#ff4d4f" />
    ...
    <section>
      ...
      <div class="icon-list">
        <div class="icon-item">
          <FxIcon name="svg:star" size="32px" color="#ff4d4f" />
          <span>svg:star</span>
        </div>
        <div class="icon-item">
          <FxIcon name="svg:heart" size="32px" color="#ff4d4f" />
          <span>svg:heart</span>
        </div>
        <div class="icon-item">
          <FxIcon name="svg:check" size="32px" color="#1677ff" />
          <span>svg:check</span>
        </div>
        <div class="icon-item">
          <FxIcon name="svg:common-batch-processing" size="32px" color="#ff4d4f" />
          <span>svg:batch-processing</span>
        </div>
        <div class="icon-item">
          <FxIcon name="svg:statusCode-404-not-found-01" size="32px" color="#ff4d4f" />
    ...
    <section>
      <h2>图标选择器（自动检测 Ant Design Vue Next）</h2>
