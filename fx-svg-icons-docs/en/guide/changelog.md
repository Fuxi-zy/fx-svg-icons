...
## ~~[v1.0.4](https://github.com/Fuxi-zy/fx-svg-icons/releases/tag/v1.0.4)~~ ⚠️ Deprecated

- Removed static imports of external icon packages from FxIconSelect presets, replaced with built-in SVGs

## ~~[v1.0.3](https://github.com/Fuxi-zy/fx-svg-icons/releases/tag/v1.0.3)~~ ⚠️ Deprecated

- Added `export` to the auto-generated `IconString` type

## ~~[v1.0.2](https://github.com/Fuxi-zy/fx-svg-icons/releases/tag/v1.0.2)~~ ⚠️ Deprecated
...
## ~~[v1.0.1](https://github.com/Fuxi-zy/fx-svg-icons/releases/tag/v1.0.1)~~ ⚠️ Deprecated
...
## ~~[v1.0.0](https://github.com/Fuxi-zy/fx-svg-icons/releases/tag/v1.0.0)~~ ⚠️ Deprecated
